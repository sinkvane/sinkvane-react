		...
		<>
			...
			<section ref={aboutRef} className={styles.about}>
				<div className={styles.aboutCards}>
					<ScrambleText as="div" text={t('whatIdo.card1.title')} />
					<p>{t('whatIdo.card1.description')}</p>
				</div>

				<div className={styles.aboutCards}>
					<ScrambleText as="div" text={t('whatIdo.card2.title')} />
					<p>{t('whatIdo.card2.description')}</p>
				</div>

				<div className={styles.aboutCards}>
					<ScrambleText as="div" text={t('whatIdo.card3.title')} />
					<p>{t('whatIdo.card3.description')}</p>
				</div>

				<div className={styles.aboutCards}>
					<ScrambleText as="div" text={t('whatIdo.card4.title')} />
					<p>{t('whatIdo.card4.description')}</p>
				</div>
			</section>

			<section className={styles.logotypes}>
				<Icon name="next" className={styles.svgLogotype} />
				<Icon name="react" className={styles.svgLogotype} />
				<Icon name="strapi" className={styles.svgLogotype} />
				<Icon name="figma" className={styles.svgLogotype} />
			</section>
		</>
	);
}
